...
def auroc(in_file_path, out_file_path):
    x = np.loadtxt(in_file_path)
    y = np.loadtxt(out_file_path)
...
def aupr_in(in_file_path, out_file_path):
    x = np.loadtxt(in_file_path)
    y = np.loadtxt(out_file_path)
...
def aupr_out(in_file_path, out_file_path):
    x = np.loadtxt(in_file_path)
    y = np.loadtxt(out_file_path)
...
def det_acc(in_file_path, out_file_path):
    x = np.loadtxt(in_file_path)
    y = np.loadtxt(out_file_path)
...
def tnr_at_tpr_95(in_file_path, out_file_path):
    x = np.loadtxt(in_file_path)
    y = np.loadtxt(out_file_path)
